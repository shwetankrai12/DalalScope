...
# Find the start of the Vanish Animation block
match = re.search(r'// --- Vanish Animation ---', html)
if not match:
    print("Error: Could not find '// --- Vanish Animation ---' marker.")
    exit(1)

top_half = html[:match.start()]

# Define the new, complete bottom half
bottom_half = """// --- Vanish Animation ---
